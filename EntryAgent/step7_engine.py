...
STRUCTURE_FIELDS = (
    ...
    "leg2_candle_a",
    "leg2_candle_a_time",
    "step5_confirmation_timer",
    "step5_participation_timer",
    ...
    "step5_participation_validated",
    "anchor_extreme_swept",
    "anchor_extreme_sweep_candle",
    "step5_trigger_valid",
    ...
    "stack_extreme_confirmation_seen",
...
STEP7_TERMINATION_FIELDS = STRUCTURE_FIELDS + (
    ...
    "step25_pathway_selection_complete",
    "step25_block_reason",
)
