...
def entry_reasoning_record(status: dict[str, Any], timestamp: str | None = None) -> dict[str, Any]:
    ...
    return {
        ...
        "step4_participation_reference_liquidity": status.get("step4_participation_reference_liquidity"),
        ...
        "step3_participation_rule_certification": status.get("step3_participation_rule_certification"),
        "step3_participation_direction": status.get("step3_participation_direction"),
        "step3_participation_candle_a_extreme": status.get("step3_participation_candle_a_extreme"),
        "step3_close_participation_pass": status.get("step3_close_participation_pass"),
        "step3_wick_participation_pct": status.get("step3_wick_participation_pct"),
        "step3_wick_participation_pass": status.get("step3_wick_participation_pass"),
...
def reasoning_state_key(record: dict[str, Any]) -> tuple[Any, ...]:
    ...
    return (
        ...
        record.get("step4_participation_reference_liquidity"),
        record.get("step4_participation_50_line"),
        record.get("step4_participation_75_line"),
        record.get("step4_participation_lines_visible"),
        record.get("step3_participation_rule_certification"),
        record.get("step3_participation_direction"),
        record.get("step3_participation_candle_a_extreme"),
        record.get("step3_close_participation_pass"),
        record.get("step3_wick_participation_pct"),
        record.get("step3_wick_participation_pass"),
