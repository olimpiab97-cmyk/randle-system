...
if ($GenerateRegistries) {
    ...
    $sourceDefinitions = @(
        ...
        (New-SourceDefinition 'R7ArtifactTool.cs' @('MEASUREMENT_TOOL','PROTECTED_METADATA_TOOL','BUILD_SUPPORT','INSTALL_SUPPORT') @('R7AR-B05','R7AR-B11','R7AR-B12','R7AR-B15') @('SAFE_FILE','DEPENDENCY_VERIFIER','OS_BOUNDARY') @('COMPILE','UTILITY_MEASUREMENT','PROTECTED_KEY_METADATA_NO_READ','STATIC_TRACE') 'NONAUTHORITATIVE_SUPPORT' @('ARTIFACT_TOOL')),
