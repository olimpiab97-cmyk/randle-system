...
if ($GenerateRegistries) {
    $scriptDefinitions = @(
        ...
        (New-ScriptDefinition 'provision_upgrade_authority.ps1' 'UNIT2_UPGRADE_BOOTSTRAP' @('UNIT2_POSTCOMMIT_PROVISIONING') 'INSTALLATION_TIME' @('POWERSHELL_ORCHESTRATOR','SC_SERVICE_CONTROL_TOOL','ICACLS_ACL_TOOL','POWERSHELL_MANAGEMENT_ASSEMBLY','PKI_MODULE_MANIFEST') 'UNIT2_EXPLICITLY_AUTHORIZED_KEY_SERVICE_AND_ROOT_BOOTSTRAP'),
