...
Bootstrap failure is not authority. The preserved exit-1639 attempt stopped before service/key/certificate creation; only its empty dedicated directories remain. The corrected bootstrap requires and propagates the exact failed-attempt evidence identity so the interruption cannot be omitted or reinterpreted as provisioning success.
